...
class LogoGather extends Component {
  ...
  render() {
    return (
      <div className="logo-gather-demo-wrapper1">
        <canvas id="canvas" />
        <TweenOne
...
class Context1 extends React.Component {
  constructor(props) {
    ...
    this.defaultImage = {
      ...
      d: svg,
      e: 'https://s4.aconvert.com/convert/p3r68-cdx67/cb8y2-lnims.svg'
    };
    this.state = {
      image: this.defaultImage.d,
      pixSize: 40,
      pointSize: 15,
      isMobile: false,
      show: false,
  ...
  render() {
    return (
      <div style={{ position: 'relative' }}>
        ...
        <div className={`logo-gather-demo-edit-wrapper1 ${this.state.show ? 'open' : ''}`}>
          {this.state.isMobile && (
